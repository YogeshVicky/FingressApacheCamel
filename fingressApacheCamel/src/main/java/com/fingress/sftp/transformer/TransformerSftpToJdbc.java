package com.fingress.sftp.transformer;
...
public class TransformerSftpToJdbc implements Processor {
	Log log = LogFactory.getLog(TransformerSftpToJdbc.class);
	...
	public void process(Exchange exchange) {
		...
		try (BufferedReader read = new BufferedReader(new StringReader(filePath))) {
			String line;
