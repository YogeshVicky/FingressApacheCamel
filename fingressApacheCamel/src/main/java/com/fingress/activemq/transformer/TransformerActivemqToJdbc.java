package com.fingress.activemq.transformer;
...
public class TransformerActivemqToJdbc implements Processor {
	Log log = LogFactory.getLog(TransformerActivemqToJdbc.class);
