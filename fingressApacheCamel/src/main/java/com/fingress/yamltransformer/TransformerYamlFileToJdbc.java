...
public class TransformerYamlFileToJdbc implements Processor {

	Log log = LogFactory.getLog(TransformerYamlFileToJdbc.class);
	...
	public void process(Exchange exchange) {
		...
		try (BufferedReader read = new BufferedReader(new FileReader(filePath))) {
			...
			while ((line = read.readLine()) != null) {
				...
				Integer empId = Integer.parseInt(String.valueOf(values[0]));
